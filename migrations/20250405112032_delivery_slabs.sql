create table "public"."delivery_slabs" (
    ...
    "handling_charge" numeric not null default 0.00,
...
alter table "public"."orders" add column "delivery_charge" numeric not null default 0.00;

alter table "public"."orders" add column "handling_charges" numeric not null default 0.00;

CREATE UNIQUE INDEX delivery_slabs_pkey ON public.delivery_slabs USING btree (id);

alter table "public"."delivery_slabs" add constraint "delivery_slabs_pkey" PRIMARY KEY using index "delivery_slabs_pkey";
...
grant delete on table "public"."delivery_slabs" to "anon";

grant insert on table "public"."delivery_slabs" to "anon";

grant references on table "public"."delivery_slabs" to "anon";

grant select on table "public"."delivery_slabs" to "anon";

grant trigger on table "public"."delivery_slabs" to "anon";

grant truncate on table "public"."delivery_slabs" to "anon";

grant update on table "public"."delivery_slabs" to "anon";

grant delete on table "public"."delivery_slabs" to "authenticated";

grant insert on table "public"."delivery_slabs" to "authenticated";

grant references on table "public"."delivery_slabs" to "authenticated";

grant select on table "public"."delivery_slabs" to "authenticated";

grant trigger on table "public"."delivery_slabs" to "authenticated";

grant truncate on table "public"."delivery_slabs" to "authenticated";

grant update on table "public"."delivery_slabs" to "authenticated";
...
grant delete on table "public"."delivery_slabs" to "service_role";

grant insert on table "public"."delivery_slabs" to "service_role";

grant references on table "public"."delivery_slabs" to "service_role";

grant select on table "public"."delivery_slabs" to "service_role";

grant trigger on table "public"."delivery_slabs" to "service_role";

grant truncate on table "public"."delivery_slabs" to "service_role";

grant update on table "public"."delivery_slabs" to "service_role";
